...
app.layout = html.Div(
    [
     ...
     html.Div(
            ...
            children=[
                html.H2("Visualization of Supermarket Sales"),
                html.A(
                    id="gh-link",
                    children=["Visit My Github"],
                    href="https://github.com/madmink",
                ...
                html.Div([
                    html.H1('Hypotesis'),
                        html.Div([
                            html.H4("DATASET"),
                            html.P('Dataset yang digunakan adalah dataset yang bersumber dari kaggle sesuai dengan notes didalam assignment'),
                            
                            html.H4("OBJEKTIF"),
                            html.P('Dataset yang digunakan adalah dataset yang bersumber dari kaggle sesuai dengan notes didalam assignment'),

                            html.H4('METODE HIPOTESIS'),
                            html.P("Metode hipotesis yang dilakukan adalah A/B Test yang digunakan untuk melakukan pengetesan atas H1 dan H0 yang akan ditentukan"),

                            html.H4('HIPOTESIS'),
                            html.P("Hipotesis yang akan di lakukan terhadap variabel independen dan dependent dimana Variable independen adalah Product Line yang akan dibandingkan antara kategori Food and Beverage dan Home & LIfe Style, sedangkan Variable dependent nya adalah Total sales dari masing masing variable independen"),                            html.H4("H0 dan H1"),
                            
                            html.H2('H0'),
                            html.P('H0 adalah adanya hubungan antara variable independen dan variable dependen'),
                            html.H2('H1'),
                            html.P('H1 adalah tidak adanya hubungan antara variable independen dan variable dependen'),

                            html.P('H0 diterima apabila uji statistik berada diluar critical value'),
                            html.P('H1 diterima apabila uji statistik berada dalam critical value'),

                            html.H4('CONFIDENCE VALUE & CRITICAL VALUE'),
                            html.P('Confidence level yang akan digunakan adalah 0.95 dikarenakan penelitian ini termasuk dalam kategori social science sehingga critical value yang akan digunakan adalah 0.05'),

                            html.H4('HYPOTESIS TESTING'),
                            html.P('dari hasil Hypotesis Testing didapatkan hasil p-value sebesar 0.83'),

                            html.H4('KESIMPULAN'),
                            html.P('H0 diterima, variable independen memiliki hubungan dengan variable dependent'),
        ...
        [
            ...
            html.Div(
                [                    
                    ...
                    html.Div(
                        [dcc.Graph(figure = update_pie_graph(), style={'height': 250})],
